...
describe("UsersController", () => {
  ...
  describe(".createUser", () => {
    const createUserDto: CreateUserDto = { email: "user@test.com", password: "password", address: "address", coordinates };
  ...
  describe(".findOneBy", () => {
    const createUserDto = { email: "user@test.com", password: "password", address:"address",
      coordinates
    };
